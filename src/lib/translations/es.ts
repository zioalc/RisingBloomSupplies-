...
export const es: Translation = {
  ...
  hero_sub:
    "Rise & Bloom lleva pestañas y productos de belleza con calidad de salón a tu casa — kits DIY, suministros de uñas y todo lo que necesitas para lucir impecable.",
  ...
  nails_section_sub:
    "Geles, tips de uñas y acabados para un manicure que dura.",
  lashes_section_sub:
    "Racimos, adhesivos y cuidado para pestañas que se mantienen todo el día.",
  makeup_section_sub:
    "Esenciales de todos los días para completar tu maquillaje.",
  tools_section_sub:
  ...
  favorites_meta_description: "Tus productos guardados de Rise & Bloom.",
  favorites_heading: "Favoritos",
  favorites_sub: "Productos que guardaste.",
  favorites_device_notice: "Solo se guardan en este navegador.",
  favorites_empty_title: "Sin favoritos",
  favorites_empty_message: "Toca el corazón en un producto para guardarlo.",
  favorites_shop_cta: "Ver la tienda",
  favorites_loading: "Cargando…",
  favorites_error: "No se pudieron cargar los favoritos.",
  favorites_unavailable_notice: "Algunos artículos se quitaron.",
  ...
  account_status_authorized: "Autorizado",
  account_status_partially_paid: "Pagado parcialmente",
  account_status_partially_refunded: "Reembolsado parcialmente",
  account_status_refunded: "Reembolsado",
  account_status_voided: "Anulado",
  ...
  story_body:
    "Rise & Bloom se enfoca en el cuidado diario de pestañas y uñas — kits DIY, extensiones y los productos que las clientas piden una y otra vez. Cada artículo en nuestra tienda está elegido por su calidad y facilidad de uso.",
  story_btn: "Comprar pestañas",
  ...
  footer_description_primary: "Suministros de pestañas y uñas Rise and Bloom",
  footer_description_secondary: "Productos de belleza",
  footer_customer_support: "Atención al cliente",
  footer_legal: "Legal",
  footer_contact_title: "Contacto",
  footer_link_contact: "Contáctanos",
  footer_link_faq: "Preguntas frecuentes",
  footer_link_shipping: "Política de envíos",
  footer_link_returns: "Política de devoluciones y reembolsos",
  footer_link_track_order: "Rastrear pedido",
  ...
  footer_link_accessibility: "Declaración de accesibilidad",
  footer_link_brand_notice: "Aviso de marca",
  footer_link_promo_terms: "Términos de promociones",
  footer_shop_hours: "Horario de la tienda",
  footer_store_location: "Visítanos",
  footer_store_name: "Nails & Lash Supplies · Bakersfield",
  footer_open_to_public: "Abierto al público",
  footer_nail_spa_support: "Apoya nuestro salón de uñas",
  hours_monday: "Lunes",
  ...
  faq_a1:
    "Cada kit incluye instrucciones paso a paso. Coloca suavemente los racimos a lo largo de la línea de pestañas usando el pegamento y sellador incluidos.",
  ...
  shipping_p1:
    "Los pedidos se procesan en 1–2 días hábiles. Recibirás un correo de confirmación cuando tu pedido sea enviado con detalles de rastreo cuando estén disponibles.",
  shipping_p2:
  ...
  gallery_tap_full_hint: "Toca la foto para verla a tamaño completo",
  ...
  shop_empty_shop_featured: "Ver destacados",
  sidebar_menu_title: "Menú",
  nav_collections: "Colecciones",
  sidebar_nails: "Uñas",
  sidebar_lashes: "Pestañas",
  sidebar_makeup: "Maquillaje",
  sidebar_tools_accessories: "Herramientas y accesorios",
  nav_shop_all: "Ver todo",
  shop_label: "RISE & BLOOM",
  shop_heading: "Shop",
  shop_sub:
    "Kits de pestañas, esenciales de uñas y productos de belleza — seleccionados para resultados de salón en casa.",
  shop_meta_title: "Shop | Rise & Bloom",
  shop_meta_description:
    "Compra kits DIY de pestañas, suministros de uñas y productos de belleza en Rise & Bloom.",
  ...
  cart_view_favorites: "Ver favoritos",
  cart_subtotal: "Subtotal",
  cart_checkout: "Pagar",
  cart_added_toast: "Agregado al carrito",
  cart_view: "Ver",
  search_title: "Search products",
  search_placeholder: "Buscar pestañas, uñas, kits…",
  search_close: "Cerrar búsqueda",
  search_hint: "Escribe al menos 2 caracteres para buscar.",
  search_loading: "Buscando…",
  search_empty: "No se encontraron productos. Intenta otra búsqueda.",
  search_error: "La búsqueda no está disponible ahora. Inténtalo de nuevo.",
  ...
  aria_view_full_image: "Ver foto completa",
  ...
  coming_soon_meta_description:
    "Rise & Bloom Nail & Lash Supplies — estamos dando los últimos toques a nuestra nueva tienda en línea.",
  coming_soon_title: "Coming Soon",
  coming_soon_body:
    "Estamos dando los últimos toques a nuestra nueva tienda en línea. ¡Vuelve pronto!",
};
